  ...
  template: `
    <div class="max-w-3xl mx-auto px-8 py-12 animate-fade">
      ...
      <div class="flex flex-col gap-6 items-center">
        <div class="text-lg">
          <div><span class="font-semibold">{{ 'ADDRESS' | translate }}:</span> 123 Green Hope Lane, Hyderabad, Telangana</div>
          <div><span class="font-semibold">{{ 'PHONE' | translate }}:</span> +91 98765 43210</div>
          <div><span class="font-semibold">{{ 'EMAIL' | translate }}:</span> info&#64;jeevangreenhope.org</div>
        </div>
